...
public class FluidCauldronBlockEntity extends BlockEntity implements ImplementedInventory {
    public final DefaultedList<ItemStack> inventory = DefaultedList.ofSize(2, ItemStack.EMPTY);

    public int maxProgress = 100;
    public int progress = 0;

    public FluidCauldronBlockEntity(BlockEntityType<?> type, BlockPos pos, BlockState state) {
    ...
    public void clearFluid(World world, BlockPos pos) {
        ...
        if (state.get(ModCauldron.FLUID_LEVEL) > 0) {
