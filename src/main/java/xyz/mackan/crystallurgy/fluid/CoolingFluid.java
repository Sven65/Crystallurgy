...
public abstract class CoolingFluid extends FlowableFluid {
    ...
    public Fluid getFlowing() {
        return ModFluids.FLOWING_COOLING_FLUID;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.COOLING_FLUID_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.COOLING_FLUID_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
