...
import xyz.mackan.crystallurgy.CrystallurgyFabric;
...
//            .build();
    ...
    public static void register() {
        //Registry.register(Registries.ITEM_GROUP, Identifier.of(CrystallurgyFabric.MOD_ID, "item_group"), CRYSTALLURGY);
    };
}
