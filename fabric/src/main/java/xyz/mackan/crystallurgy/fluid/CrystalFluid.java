...
public abstract class CrystalFluid extends FlowableFluid {
    @Override
    ...
    public Fluid getFlowing() {
        return ModFluids.FLOWING_CRYSTAL_FLUID;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.CRYSTAL_FLUID_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.CRYSTAL_FLUID_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
