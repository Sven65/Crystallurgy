...
public class FluidStackRenderer implements IIngredientRenderer<FluidUtils.DecodedFluid> {
    ...
    @Override
    public List<Text> getTooltip(FluidUtils.DecodedFluid fluidStack, TooltipContext tooltipFlag) {
        ...
        MutableText displayName = Text.translatable("block." + Registries.FLUID.getId(fluidStack.fluid()).toTranslationKey());
    ...
    public List<OrderedText> getOrderedTooltip(FluidUtils.DecodedFluid fluidStack, TooltipContext tooltipFlag) {
