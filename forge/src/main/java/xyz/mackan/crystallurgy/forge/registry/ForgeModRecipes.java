...
public class ForgeModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<FluidSynthesizerRecipe>> FLUID_SYNTH_SERIALIZER = SERIALIZERS.register("fluid_synthesizing", () -> FluidSynthesizerRecipe.Serializer.INSTANCE);
