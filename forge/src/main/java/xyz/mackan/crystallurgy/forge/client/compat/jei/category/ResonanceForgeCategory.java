...
public class ResonanceForgeCategory implements IRecipeCategory<ResonanceForgeRecipe> {
    ...
    public static final Identifier TEXTURE = Constants.id("textures/gui/resonance_forge.png");
    ...
    public ResonanceForgeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ForgeModBlocks.RESONANCE_FORGE.get()));
    }
