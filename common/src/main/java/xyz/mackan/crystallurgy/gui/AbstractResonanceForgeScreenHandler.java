...
public abstract class AbstractResonanceForgeScreenHandler extends ScreenHandler {
    protected Inventory inventory;
    protected PropertyDelegate propertyDelegate;

    protected AbstractResonanceForgeScreenHandler(@Nullable ScreenHandlerType<?> type, int syncId) {
        super(type, syncId);
    }
