...
public class ResonanceForge extends BlockWithEntity implements BlockEntityProvider {
    private static final VoxelShape shape = BlockWithEntity.createCuboidShape(0, 0,0, 16, 16, 16);
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof ResonanceForgeBlockEntity) {
                ItemScatterer.spawn(world, pos, (ResonanceForgeBlockEntity)blockEntity);
